...
(observed 2026-07-30). Adopted with CSC Goal #200 (Task #444).

```bash
ssh root@192.168.0.2 'qm rollback 104 clean-install-0-6-8-beta-2 && qm start 104'
...
`ssh PC@192.168.0.252 'curl.exe -s -m 2 http://127.0.0.1:8900/health'` until
`"ok": true`.
