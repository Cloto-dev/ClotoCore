...
/// its seal was signed over (ClotoHub Goal #188 — `dual-v2` seals).
enum ArchiveBinding {
...
fn local_seal_for_install(
    ...
    // Task #322: seal the installed tree rather than the entry point alone.
...
///
/// A `dual-v2` seal (ClotoHub Goal #188) carries the digest **and length
...
mod tests {
    ...
    // ── dual-v2 seals: the archive binding (ClotoHub Goal #188) ──
    //
