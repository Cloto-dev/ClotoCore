...
mod tests {
    ...
    // ── 20260701120000_retire_mind_prefix (Goal #142 / Task #128) ──
    ...
    // ── 20260704130000_retire_category_prefixes (Goal #143 / Task #153) ──
    ...
    async fn category_prefix_migration_renames_merges_and_maps_gaze() {
        ...
        // Goal #142 residue: cron_jobs.engine_id de-prefixed; bare and NULL
        // values untouched.
