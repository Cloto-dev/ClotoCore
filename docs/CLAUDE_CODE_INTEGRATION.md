...
```bash
cd C:/Users/user/source/repos/clotohub-servers/servers
python -m venv .venv
...
claude mcp add-json embedding '{
  "type": "stdio",
  "command": "C:/Users/user/source/repos/clotohub-servers/servers/.venv/Scripts/python.exe",
  "args": ["C:/Users/user/source/repos/clotohub-servers/servers/embedding/server.py"],
  "env": {
...
claude mcp add-json cpersona '{
  "type": "stdio",
  "command": "C:/Users/user/source/repos/CPersona/.venv/Scripts/python.exe",
  "args": ["C:/Users/user/source/repos/CPersona/server.py"],
  "env": {
    "CPERSONA_DB_PATH": "C:/Users/user/.claude/cpersona.db",
