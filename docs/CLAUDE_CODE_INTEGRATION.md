...
```bash
cd C:/Users/user/source/repos/cloto-mcp-servers/servers
python -m venv .venv
...
claude mcp add-json embedding '{
  "type": "stdio",
  "command": "C:/Users/user/source/repos/cloto-mcp-servers/servers/.venv/Scripts/python.exe",
  "args": ["C:/Users/user/source/repos/cloto-mcp-servers/servers/embedding/server.py"],
  "env": {
...
claude mcp add-json cpersona '{
  "type": "stdio",
  "command": "C:/Users/user/source/repos/cloto-mcp-servers/servers/.venv/Scripts/python.exe",
  "args": ["C:/Users/user/source/repos/cloto-mcp-servers/servers/cpersona/server.py"],
  "env": {
