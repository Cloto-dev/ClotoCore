...
feature; they are fixed under an earlier decision.
...
## 6. Source A — stderr forwarding (an earlier decision)
...
## 7. Source B — MCP logging capability (an earlier decision)
...
## 8. Frontend (an earlier decision)
...
## 12. Task mapping (an earlier decision)
